...
class CommandName(StrEnum):
    ...
    FLATPAK_USER_APP_LIST = "flatpak-user-app-list"
    FLATPAK_USER_RUNTIME_LIST = "flatpak-user-runtime-list"
    FLATPAK_SYSTEM_APP_LIST = "flatpak-system-app-list"
    FLATPAK_SYSTEM_RUNTIME_LIST = "flatpak-system-runtime-list"
